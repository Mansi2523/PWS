<%@ Page Title=" Manage Admin" Language="C#" MasterPageFile="~/Sitemaster/AdminMaster.master" AutoEventWireup="true" CodeFile="ManageWarStories.aspx.cs" Inherits="Admin1_ManageWarStories" %>
                ...
                <div class="portlet-body form" style="display: block">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Select War Title</label>
                            <asp:DropDownList ID="drpwarlist" runat="server" CssClass="form-control"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Select War Detail</label>
                            <asp:DropDownList ID="drpwardetail" runat="server" CssClass="form-control"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit bordered">
                        ...
                        <div class="portlet-body form" id="divaddform">
                            <div class="alert alert-danger display-hide" id="wartitle">
                                <button class="close" data-close="alert"></button>
                                <span>Select War Title. </span>
                            </div>
                            <div class="alert alert-danger display-hide" id="wardetail">
                                <button class="close" data-close="alert"></button>
                                <span>Se;ect War Detail. </span>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Select War Title</label>
                                    <asp:DropDownList ID="drpwartitleadd" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Select War Detail</label>
                                    <asp:DropDownList ID="drpwardetailadd" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
