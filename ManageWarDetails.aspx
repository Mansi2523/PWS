<%@ Page Title=" Manage Admin" Language="C#" MasterPageFile="~/Sitemaster/AdminMaster.master" AutoEventWireup="true" CodeFile="ManageWarDetails.aspx.cs" Inherits="Admin1_ManageWarDetails" %>
                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit bordered">
                        ...
                        <div class="portlet-body form" id="divaddform">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>War Detail Title<span class="required">*</span></label>
